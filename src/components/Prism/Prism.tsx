...
const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const render = (t: number) => {
      ...
      if(animationType==='hover'){
        targetYaw=pointer.inside?-pointer.x*0.6*HOVSTR:0;
        targetPitch=pointer.inside?pointer.y*0.6*HOVSTR:0;
    ...
    return () => {
      ...
      if(suspendWhenOffscreen&&(container as any).__prismIO){ (container as any).__prismIO.disconnect(); delete (container as any).__prismIO; }
